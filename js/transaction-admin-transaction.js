...
function fetchAndPopulateDataTransactionManage() {
  ...
  document.addEventListener('DOMContentLoaded', function() {
    var gridDivTransactionManage = document.querySelector('#gridTransactionManage');
    new agGrid.Grid(gridDivTransactionManage, gridOptions5);
  
    // Fetch and populate data
    fetchAndPopulateDataTransactionManage();
  });